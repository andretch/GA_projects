...
-- Check countries with highest infection rates; i.e. total cases vs population (viz 2)
...
-- Check country infection rates over time (viz 3)
...
-- Check the death count by region (viz 4)
